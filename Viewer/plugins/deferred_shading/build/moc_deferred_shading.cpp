...
struct qt_meta_stringdata_Deferred_shading_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Deferred_shading_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Deferred_shading_t qt_meta_stringdata_Deferred_shading = {
    {
QT_MOC_LITERAL(0, 0, 16) // "Deferred_shading"
...
static const uint qt_meta_data_Deferred_shading[] = {
...
QT_INIT_METAOBJECT const QMetaObject Deferred_shading::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Deferred_shading.data,
    qt_meta_data_Deferred_shading,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Deferred_shading::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Deferred_shading.stringdata0))
