...
struct qt_meta_stringdata_Draw_smooth_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Draw_smooth_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Draw_smooth_t qt_meta_stringdata_Draw_smooth = {
    {
QT_MOC_LITERAL(0, 0, 11) // "Draw_smooth"
...
static const uint qt_meta_data_Draw_smooth[] = {
...
QT_INIT_METAOBJECT const QMetaObject Draw_smooth::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Draw_smooth.data,
    qt_meta_data_Draw_smooth,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Draw_smooth::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Draw_smooth.stringdata0))
