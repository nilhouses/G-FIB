...
#ifndef _DRAW_INSTANCES_H
#define _DRAW_INSTANCES_H
...
class DrawInstances : public QObject, public Plugin
{
  Q_OBJECT
 ...
 private:
  ...
  //NOU
  int numInstances = 9; // Per saber quantes instàncies volem dibuixar
};
